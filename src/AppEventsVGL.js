...
export default function AppEventsVGL() {
  ...
  return (
    ...
    <Navbar setMenu ={setMenu}/>
      ...
      <FrontPage heading="RECON" text2="Initiale | Elevate."/>
      <AboutText heading="ABOUT THE EVENT" text="THE MAIN IDEA OF INITIATE & ELEVATE IS TO START OFF THE EVENT AND ELEVATE IT TO TAKE IT TO THE NEXT LEVEL. THE EVENT WILL BE FOR ALL-INDIA COLLEGE STUDENTS. IT WILL BE CONDUCTED OFFLINE IN VIT ON 30TH SEP-2ND OCT 2022 IN VIT VELLORE CAMPUS.WE PLAN TO CONDUCT THE EVENT IN TWO PHASES, PHASE 1 BEING A GAME.DEVELOPMENT HACKATHON AND PHASE 2 BEING AN ALL INDIA ESPORTS TOURNAMENT. THE DETAILS ARE AS FOLLOWS:-

STUDIO-TO-STAGE (GAME DEV HACKATHON OR GAMEUAM) - IT IS A
...
GAME-A-THON (GAT) - THIS IS TAG'S ALL INDIA ESPORTS TOURNAMENT.
...
FOR SOLO PARTICIPANTS, WE WILL BE ALLOTTING. TEAMS BASED ON THEIR ;

 

RANKS. THE MATCHMAKING WILL BE DONE ACCORDINGLY. THE WINNERS ANI
